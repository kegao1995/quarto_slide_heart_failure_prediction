...
![](figure/Decision_Tree_CV.png){fig-width=50%}
   ...
   - <span style="color:red">potential bias towards dominant classes in umbalanced datasets</span>
...
### **Model Selection**
We selected the logistic regression due to its:
...
82% Accuracy    70% Precision    74% Recall     0.72 F1-score

- The model is moderately accurate in predicting deaths
- Captures majority of the high-risk patients
- However, model needs a serious improvement in Recall by reducing false negatives

---

## Why do we want to improve recall?
 
![Performance Radar](figure/results_radar.png){#fig-radar fig-width=10 fig-height=10 fig-align="center"}

- Risk awareness is very important in healthcare predictive modelling
- It's often safer to overestimate positive outcomes than to risk missing critical conditions

<span style="font-size:18px;">"In medicine, the most dangerous thing is not to make a mistake, but to fail to see the potential risks that lie hidden"  - Dr. Eric Topol </span>

---

### **Challenges in Healthcare Data for Predictive Modeling**

- Scarcity of healthcare data: Limited patient records available
- Data quality issues: Healthcare data is often incomplete, messy or hidden due to confidentiality 
- Class imbalance in responses: Significantly fewer instances of Death Event = `1` compared to '0'

![](figure/class_imbalance.png){#fig-radar fig-width=6 fig-height=6 fig-align="center"}

---

### **Proposed Improvements: **

- Collect higher-quality patient data (clean, complete and diverse data)
- Include additional features like genetic predispositions, family medical history and lifestyle factors
- Experimenting with ensemble models (e.g., Random Forest, Gradient Boosting) or Neural Networks

This can be achieved by improving data and AI literacy and ensuring medical professionals actively engage in maintaining clean, diverse and complete medical records
