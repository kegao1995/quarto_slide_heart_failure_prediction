...
- Moderately accurate - conservative
![](figure/recall.jpeg){fig-width=7 fig-align="rigth"}
...
Patient Data is:
       ...
       Scarce            Incomplete              
 Hidden due to confidenciality    Messy
   Imbalanced class       Inconsistent

![](figure/class_imbalance.png){#fig-radar fig-width=8 fig-height=8 fig-align="center"}

---

![](figure/patient_data.png){#fig-radar fig-width=8 fig-height=8 fig-align="center"}
...
- Include diverse features (genetic predispositions, lifestyle factors)
